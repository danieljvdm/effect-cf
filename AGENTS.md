...
- Effect source code can be referenced at `repos/effect` for patterns and API style when changing Effect-heavy code. Do not edit files under `repos/effect`; it is a reference checkout, not package source.
