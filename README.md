...
Alchemy v2 also provides [Effect RPC](https://alchemy.run/cloudflare/apis/effect-rpc/), [alarms and hibernating WebSockets](https://alchemy.run/cloudflare/compute/hibernatable-websockets/), and [native tracing](https://alchemy.run/cloudflare/observability/workers-tracing/). The reasons to add `effect-cf` are more specific:
