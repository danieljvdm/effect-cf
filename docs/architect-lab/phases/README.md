...
- [Phase 4: AI Architect With Fake Provider](./phase-4-ai-architect-with-fake-provider.md) - In progress; fake provider, Queue flow, room-authoritative AI validation, and room-owned tldraw mutation implemented
